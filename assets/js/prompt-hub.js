...
.search-input {
  ...
  border: 1px solid rgba(45, 207, 177, .35) !important;
...
.search-input:focus {
  border-color: #2dcfb1 !important;
  box-shadow: 0 0 0 4px rgba(45,207,177,.12) !important;
}
...
.cat-btn.active {
  background: rgba(45,207,177,.12) !important;
}
...
.card {
  ...
  box-shadow: 0 8px 24px rgba(23,32,51,.07) !important;
  overflow: hidden;
}
